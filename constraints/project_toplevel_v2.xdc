...
set_property PACKAGE_PIN M15 [get_ports status_led]
set_property IOSTANDARD LVCMOS33 [get_ports status_led]

set_property PACKAGE_PIN R13 [get_ports uart_tx]
set_property IOSTANDARD LVCMOS33 [get_ports uart_tx]

set_property PACKAGE_PIN T13 [get_ports uart_rx]
set_property IOSTANDARD LVCMOS33 [get_ports uart_rx]

set_property PACKAGE_PIN D4 [get_ports dac_clk]
set_property IOSTANDARD LVCMOS33 [get_ports dac_clk]

set_property PACKAGE_PIN D3 [get_ports {dac_out[0]}]
set_property PACKAGE_PIN C3 [get_ports {dac_out[1]}]
set_property PACKAGE_PIN C2 [get_ports {dac_out[2]}]
set_property PACKAGE_PIN C1 [get_ports {dac_out[3]}]
set_property PACKAGE_PIN B1 [get_ports {dac_out[4]}]
set_property PACKAGE_PIN D1 [get_ports {dac_out[5]}]
set_property PACKAGE_PIN E2 [get_ports {dac_out[6]}]
set_property PACKAGE_PIN A2 [get_ports {dac_out[7]}]
set_property PACKAGE_PIN B2 [get_ports {dac_out[8]}]
set_property PACKAGE_PIN E1 [get_ports {dac_out[9]}]
set_property PACKAGE_PIN F2 [get_ports {dac_out[10]}]
set_property PACKAGE_PIN F3 [get_ports {dac_out[11]}]
set_property PACKAGE_PIN K3 [get_ports {dac_out[12]}]
set_property PACKAGE_PIN K2 [get_ports {dac_out[13]}]
