...
set_property PACKAGE_PIN P5 [get_ports {adc_data_in[0]}]
set_property PACKAGE_PIN L5 [get_ports {adc_data_in[1]}]
set_property PACKAGE_PIN M5 [get_ports {adc_data_in[2]}]
set_property PACKAGE_PIN N4 [get_ports {adc_data_in[3]}]
set_property PACKAGE_PIN L4 [get_ports {adc_data_in[4]}]
set_property PACKAGE_PIN M4 [get_ports {adc_data_in[5]}]
set_property PACKAGE_PIN P4 [get_ports {adc_data_in[6]}]
set_property PACKAGE_PIN P3 [get_ports {adc_data_in[7]}]
set_property PACKAGE_PIN N3 [get_ports {adc_data_in[8]}]
set_property PACKAGE_PIN N2 [get_ports {adc_data_in[9]}]
set_property PACKAGE_PIN R10 [get_ports {adc_data_in[10]}]
set_property PACKAGE_PIN R11 [get_ports {adc_data_in[11]}]
set_property PACKAGE_PIN R12 [get_ports {adc_data_in[12]}]
set_property PACKAGE_PIN T12 [get_ports {adc_data_in[13]}]
set_property IOSTANDARD LVCMOS33 [get_ports adc_data_in]

set_property PACKAGE_PIN P14 [get_ports adc_clk]
