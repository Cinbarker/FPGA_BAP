...
set_property PACKAGE_PIN D4 [get_ports {dac_out[0]}]
set_property PACKAGE_PIN C4 [get_ports {dac_out[1]}]
set_property PACKAGE_PIN E3 [get_ports {dac_out[2]}]
set_property PACKAGE_PIN D3 [get_ports {dac_out[3]}]
set_property PACKAGE_PIN C3 [get_ports {dac_out[4]}]
set_property PACKAGE_PIN C2 [get_ports {dac_out[5]}]
set_property PACKAGE_PIN C1 [get_ports {dac_out[6]}]
set_property PACKAGE_PIN B1 [get_ports {dac_out[7]}]
set_property PACKAGE_PIN N12 [get_ports {dac_out[8]}]
set_property PACKAGE_PIN N11 [get_ports {dac_out[9]}]
set_property PACKAGE_PIN M6 [get_ports {dac_out[10]}]
set_property PACKAGE_PIN N6 [get_ports {dac_out[11]}]
set_property PACKAGE_PIN J5 [get_ports {dac_out[12]}]
set_property PACKAGE_PIN J4 [get_ports {dac_out[13]}]
